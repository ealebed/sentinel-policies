...
# Vertex AI Dataset policies
policy "ensure-CMEK-is-used-on-dataset" {
    source = "./vertex-ai-dataset/ensure-CMEK-is-used/ensure-CMEK-is-used.sentinel"
    enforcement_level = "advisory"
}
...
policy "ensure-custom-SA-is-used-on-notebook-instance-config" {
    source = "./vertex-ai/ensure-custom-SA-is-used-config/ensure-custom-SA-is-used-config.sentinel"
    enforcement_level = "advisory"
}

policy "ensure-custom-SA-is-used-on-notebook-instance-plan" {
    source = "./vertex-ai/ensure-custom-SA-is-used-plan/ensure-custom-SA-is-used-plan.sentinel"
    enforcement_level = "advisory"
}
...
policy "ensure-labels-is-used-on-project" {
    source = "./project/ensure-labels-is-used/ensure-labels-is-used.sentinel"
    enforcement_level = "advisory"
}
